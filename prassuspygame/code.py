...
secret_msg_1=fuse_msg(message_1[0],message_2[0])
...
secret_msg_2=substitute_msg(message_3[0])
...
secret_msg_3=compare_msg(message_4[0],message_5[0])
...
#Printing the secret message
secret_msg_4=extract_msg(message_6[0])
